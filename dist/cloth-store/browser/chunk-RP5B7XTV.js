// src/app/core/catalog/size-color.catalog.ts
var ALL_COLORS = [
  "Black",
  "White",
  "Navy",
...
function sizesForGuide(sizeGuide, categoryName) {
...
function colorsForCategory(_categoryName) {
  return [...ALL_COLORS];
}
function isLeoWearBrand(brand) {
  if (!brand)
    return false;
...
//# sourceMappingURL=chunk-RP5B7XTV.js.map
